...
pkgdatadir = $(datadir)/apertium-eng
pkgincludedir = $(includedir)/apertium-eng
pkglibdir = $(libdir)/apertium-eng
pkglibexecdir = $(libexecdir)/apertium-eng
...
CONFIG_CLEAN_FILES = apertium-eng.pc
...
am__installdirs = "$(DESTDIR)$(apertium_engdir)" \
	"$(DESTDIR)$(pkgconfigdir)"
DATA = $(apertium_eng_DATA) $(noinst_DATA) $(pkgconfig_DATA)
am__tagged_files = $(HEADERS) $(SOURCES) $(TAGS_FILES) $(LISP)
am__DIST_COMMON = $(srcdir)/Makefile.in $(srcdir)/apertium-eng.pc.in \
...
ACLOCAL = ${SHELL} '/Users/himanshu/GSOC/Apertium_MT/apertium-eng/missing' aclocal-1.16
AMTAR = $${TAR-tar}
...
AUTOCONF = ${SHELL} '/Users/himanshu/GSOC/Apertium_MT/apertium-eng/missing' autoconf
AUTOHEADER = ${SHELL} '/Users/himanshu/GSOC/Apertium_MT/apertium-eng/missing' autoheader
AUTOMAKE = ${SHELL} '/Users/himanshu/GSOC/Apertium_MT/apertium-eng/missing' automake-1.16
AWK = gawk
...
CTAGS = ctags
CYGPATH_W = echo
DEFS = -DPACKAGE_NAME=\"Apertium\ English\" -DPACKAGE_TARNAME=\"apertium-eng\" -DPACKAGE_VERSION=\"0.1.0\" -DPACKAGE_STRING=\"Apertium\ English\ 0.1.0\" -DPACKAGE_BUGREPORT=\"apertium-stuff@lists.sourceforge.net\" -DPACKAGE_URL=\"https://wiki.apertium.org/wiki/Apertium-eng\" -DPACKAGE=\"apertium-eng\" -DVERSION=\"0.1.0\"
ECHO_C = \c
ECHO_N = 
ECHO_T = 
ETAGS = etags
...
MAKEINFO = ${SHELL} '/Users/himanshu/GSOC/Apertium_MT/apertium-eng/missing' makeinfo
MKDIR_P = ./install-sh -c -d
PACKAGE = apertium-eng
PACKAGE_BUGREPORT = apertium-stuff@lists.sourceforge.net
PACKAGE_NAME = Apertium English
PACKAGE_STRING = Apertium English 0.1.0
PACKAGE_TARNAME = apertium-eng
PACKAGE_URL = https://wiki.apertium.org/wiki/Apertium-eng
...
STRIP = 
VERSION = 0.1.0
abs_builddir = /Users/himanshu/GSOC/Apertium_MT/apertium-eng
abs_srcdir = /Users/himanshu/GSOC/Apertium_MT/apertium-eng
abs_top_builddir = /Users/himanshu/GSOC/Apertium_MT/apertium-eng
abs_top_srcdir = /Users/himanshu/GSOC/Apertium_MT/apertium-eng
am__leading_dot = .
...
install_sh = ${SHELL} /Users/himanshu/GSOC/Apertium_MT/apertium-eng/install-sh
...
$(am__aclocal_m4_deps):
apertium-eng.pc: $(top_builddir)/config.status $(srcdir)/apertium-eng.pc.in
	cd $(top_builddir) && $(SHELL) ./config.status $@
install-apertium_engDATA: $(apertium_eng_DATA)
	@$(NORMAL_INSTALL)
	@list='$(apertium_eng_DATA)'; test -n "$(apertium_engdir)" || list=; \
	if test -n "$$list"; then \
	  echo " $(MKDIR_P) '$(DESTDIR)$(apertium_engdir)'"; \
	  $(MKDIR_P) "$(DESTDIR)$(apertium_engdir)" || exit 1; \
	fi; \
	for p in $$list; do \
	...
	while read files; do \
	  echo " $(INSTALL_DATA) $$files '$(DESTDIR)$(apertium_engdir)'"; \
	  $(INSTALL_DATA) $$files "$(DESTDIR)$(apertium_engdir)" || exit $$?; \
	done

uninstall-apertium_engDATA:
	@$(NORMAL_UNINSTALL)
	@list='$(apertium_eng_DATA)'; test -n "$(apertium_engdir)" || list=; \
	files=`for p in $$list; do echo $$p; done | sed -e 's|^.*/||'`; \
	dir='$(DESTDIR)$(apertium_engdir)'; $(am__uninstall_files_from_dir)
...
installdirs:
	for dir in "$(DESTDIR)$(apertium_engdir)" "$(DESTDIR)$(pkgconfigdir)"; do \
...
install-data-am: install-apertium_engDATA install-data-local \
...
uninstall-am: uninstall-apertium_engDATA uninstall-pkgconfigDATA
...
.PHONY: all all-am am--refresh check check-am clean clean-generic \
	...
	info-am install install-am install-apertium_engDATA \
	...
	uninstall uninstall-am uninstall-apertium_engDATA \
	uninstall-pkgconfigDATA
